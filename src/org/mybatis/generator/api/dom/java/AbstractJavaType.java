...
public abstract class AbstractJavaType extends JavaElement {
	...
	protected Set<FullyQualifiedJavaType> superInterfaceTypes = new LinkedHashSet<>();

    protected List<InnerClass> innerClasses = new ArrayList<>();

    protected List<InnerEnum> innerEnums = new ArrayList<>();

    protected List<InnerInterface> innerInterfaces = new ArrayList<>();
     ...
     * @param field
     */
    public void addField(Integer index, Field field) {
