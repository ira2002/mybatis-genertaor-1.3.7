    ...
    public List<GeneratedJavaFile> getGeneratedJavaFiles() {
        ...
        for (int i = 0; i < list.size(); i++) {
			...
			if (p.toXmlElement().getFormattedContent(0).contains("CriteriaPlugin")) {
				//可对CriteriaPlugin设置isExample属性控制是否生成example类
				isExample = "true".equals(p.getProperty("isExample")) ? true : false;
			}
		}
        ...
        for (AbstractJavaGenerator javaGenerator : javaGenerators) {
            ...
            for (CompilationUnit compilationUnit : compilationUnits) {
            	//
            	//System.err.println(compilationUnit.getFormattedContent());
    ...
    public List<GeneratedXmlFile> getGeneratedXmlFiles() {
        ...
        if (xmlMapperGenerator != null) {
            ...
            GeneratedXmlFile gxf = new GeneratedXmlFile(document,
                    ...
                    false,/*TODO xml文件内容是否追加:isMergeable=true*/ context.getXmlFormatter());
