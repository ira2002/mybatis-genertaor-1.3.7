...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        //TODO 增加dao.java注释
        context.getCommentGenerator().addInterfaceComment(interfaze, introspectedTable);
        
        //TODO 增加dao层接口注解@Mapper,此在Spring-boot下为必须,否则Service层注入dao对象失败
        FullyQualifiedJavaType importedType = new FullyQualifiedJavaType("org.apache.ibatis.annotations.Mapper");
		interfaze.addImportedType(importedType );
		interfaze.addAnnotation("@Mapper");
		//TODO 移除dao层的参数注解@Param对应的import导入
		importedType = new FullyQualifiedJavaType("org.apache.ibatis.annotations.Param");
		interfaze.removeImportedType(importedType);
        return answer;
    }
